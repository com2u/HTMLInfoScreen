class InfoPage {
  ...
  gizmoColor = 0;
  gizmoColor2 = 255;
  backgroundPicture: PImage
  textGraphics: PGraphics
  drawMode = GizmoDrawMode.DOT;
  reseedMode = GizmoReseedMode.NEXTEDGE;
  moveMode = GizmoMoveMode.ANGLE;
  targetMode = GizmoTargetMode.EDGE;
}


function initInfoPages(infoPage: InfoPage[]) {
